    ...
    <div class='nav-div'>
       ...
       <div class="container">
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
           ...
           <button class="btn mr-5" data-bs-toggle="modal" data-bs-target="#enrollnow"  style="background:#B81398;color:#fff; font-family:Poppins;">Enroll Now</button>
    ...
    <div class="modal-dialog modal-dialog-centered ">
      <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="text-center modal-title " id="enrollnow"  style="color: #B81398;font-family:Poppins;"> Enroll Now </h4>
